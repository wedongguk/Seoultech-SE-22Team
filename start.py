...
def start(screen, screen_width, screen_height, num, name):
    ...
    while True:
        ...
        pos = (
        (board_rect[0] + (board_rect[0] + board_rect[2])) / 2, (board_rect[1] + (board_rect[1] + board_rect[3])) / 2)
        topC = createOneCard(topCard, pos, (50, 70))
        init_view(screen, [topC])

        pos = ((board_rect[0] + (board_rect[0] + board_rect[2])) / 2 + 50,
               (board_rect[1] + (board_rect[1] + board_rect[3])) / 2)
